...
# 设备连接信息
DeviceIp = '192.168.110.239'
DevicePort = 8000
DeviceUserName = 'admin'
DevicePassword = 'TJDX8888'

# HCNetSDK库文件路径
HCNetSDK_Path = r'./HCNetSDK.dll'

# PlatCtrlSDK库文件路径
PlayCtrlSDK_Path = r'./PlayCtrl.dll'
...
def InitHCNetSDK(dll):
    ...
    dll.NET_DVR_Init()
    # 设置设备超时时间
    dll.NET_DVR_SetConnectTime(int(2000), 1)
...
def RealDataCallBack(lPlayHandle, dwDataType, pBuffer, dwBufSize, pUser):
    if dwDataType == NET_DVR_SYSHEAD:
        ...
        # 打开流播放
        if pdll.PlayM4_OpenStream(PLAYCTRL_PORT, pBuffer, dwBufSize, 1024 * 100000):
